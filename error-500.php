...
<head>
  ...
  <meta name="description"
    content="Oops! Something went wrong on our server. We're working to fix the issue. Please try again later.">
  <meta name="keywords" content="500 error, internal server error, server issue, website error, kishan modi">
  <meta name="robots" content="noindex, nofollow">

  <link rel='shortcut icon' type='image/x-icon' href='assets/images/favicon.png' />
  <title>Error 500 | Internal Server Error | #thekishanmodi</title>
  <style>
    @font-face {
      font-family: Museo;
...
<body>
  <canvas id="canvas" style="position: fixed; top: 0; left: 0; z-index: -1; min-height: 350px;"></canvas>
  <section style="position: absolute; top: 10%; width: 100%; left: 0;">
    <h1 style="font-weight: 900;font-size: 60px;">Internal Server Error</h1>
    <h2 style="font-weight: 300;font-size: 32px;">Oops! Our pixels took a vacation. Be back soon!</h2>
  </section>
